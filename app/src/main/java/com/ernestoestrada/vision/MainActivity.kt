package com.ernestoestrada.vision
...
class MainActivity : AppCompatActivity() {
    ...
    inner class GVisionThread: AsyncTask<String, String, String>() {
        ...
        override fun doInBackground(vararg arg: String?):String {
            ...
            desiredFeature.type = "SAFE_SEARCH_DETECTION"
    ...
    companion object {
        ...
        private const val API_KEY = "AIzaSyAaMI9iXEC2Ab5xCouXiE6s2qDBWrjryk0"//your API Key should be placed here
    }
